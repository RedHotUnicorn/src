---
title: GitHub - KoboldAI/KoboldAI-Client
date: 2023-03-03
src_link: https://www.notion.so/GitHub-KoboldAI-KoboldAI-Client-gpt-0273a933430a4f7abe3dbeb345af4f93
src_date: '2023-03-03 14:31:00'
gold_link: https://github.com/KoboldAI/KoboldAI-Client
gold_link_hash: f78822f1349f5abaac22da49fdbda06a
tags:
- '#host_github_com'
---
...
| [Emerhyst 13B](https://huggingface.co/Undi95/Emerhyst-13B) by Undi | Roleplay | An attempt using BlockMerge\_Gradient to get better result. In addition, LimaRP v3 was used⁷. |
...
| [Spring Dragon by Henk717](https://huggingface.co/Henk717/spring-dragon) | Adventure | This model is a recreation attempt of the AI Dungeon 2 Dragon model. To achieve this, the "text\_adventures.txt" dataset was used, which was bundled with the original AI Dungeon 2 GitHub release prior to the online service. It is worth noting that the same dataset file was used to create the Dragon model, where Dragon is a GPT-3 175B Davinci model from 2020. |
| [Holodeck By KoboldAI](https://huggingface.co/KoboldAI/LLAMA2-13B-Holodeck-1) | Adventure | LLAMA2 13B-Holodeck is a finetune created using Meta's llama 2 model.The training data contains around 3000 ebooks in various genres. Most parts of the dataset have been prepended using the following text: [Genre: , |
...
| [Various 2.7b models](/KoboldAI/KoboldAI-Client/blob/main) by various | Various smaller models are also possible to load in GPU colab. |
...
KoboldAI is a rolling release on our github, the code you see is also the game. You can download the software by clicking on the green Code button at the top of the page and clicking Download ZIP, or use the `git clone` command instead. Then, on Windows you need to you run install\_requirements.bat (using admin mode is recommanded to avoid errors), and once it's done, or if you're on Linux, either play.bat/sh or remote-play.bat/sh to run it.
...
KoboldAI has a REST API that can be accessed by adding /api to the URL that Kobold provides you (For example [http://127.0.0.1:5000/api](http://127.0.0.1:5000/api)).
