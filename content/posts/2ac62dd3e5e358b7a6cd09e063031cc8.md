---
title: 'GitHub - GoogleCloudPlatform/professional-services-data-validator: Utility
  to compare data between homogeneous or heterogeneous environments to ensure source
  and target tables match'
date: 2023-04-20
src_link: https://www.notion.so/GoogleCloudPlatform-professional-services-data-validator-Utility-to-compare-data-between-homogeneou-fc96f40353bf491e936675aa0e1421c5
src_date: '2023-04-20 16:08:00'
gold_link: https://github.com/GoogleCloudPlatform/professional-services-data-validator
gold_link_hash: 2ac62dd3e5e358b7a6cd09e063031cc8
tags:
- '#host_github_com'
---
...
in the SELECT statement of both source\_query.sql and target\_query.sql. See *Primary Keys* section
...
Filters let you apply a WHERE statement to your validation query (ie. `SELECT * FROM table WHERE created_at > 30 days ago AND region_id = 71;`). The filter is
